...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this dependent should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
        ...
        migrations.AddField(
            model_name='cliente',
            name='dependentes',
            field=models.ManyToManyField(to='core.Dependente'),
        ),
        migrations.AddField(
            model_name='cliente',
            name='user',
