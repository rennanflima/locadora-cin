# Generated by Django 2.1.5 on 2019-02-07 02:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_dado', models.CharField(choices=[('TEXTO', 'Texto'), ('INTEIRO', 'Inteiro'), ('DECIMAL', 'Decimal'), ('BOOLEAN', 'Boolean'), ('DATA', 'Data'), ('HORA', 'Hora'), ('DATA_HORA', 'Data/Hora')], max_length=20, verbose_name='Tipo de dado do argumento')),
            ],
            options={
